...
#######################################################################################################################
    ...
    def run(self):
        try:
            ...
            raise exceptions.HelpfulError(
                ...
                % ['n/a', 'Token', 'Email/Password', 'Credentials'][len(self.config.auth)]
    ...
    async def cmd_help(self, command=None):
        ...
        if command:
            ...
            helpmsg += "```"
            # helpmsg += "https://github.com/Just-Some-Bots/MusicBot/wiki/Commands" # Spammy.
    ...
    async def cmd_play(self, player, channel, author, permissions, leftover_args, song_url):
        ...
        if 'entries' in info:
            ...
            # monitor it and edit the message with the estimated time, but that's some ADVANCED STUFF
    ...
    async def cmd_search(self, player, channel, author, permissions, leftover_args):
        ...
        # Look jake, if you see this and go "what the eff are you doing"
